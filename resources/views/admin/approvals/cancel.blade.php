<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <a href="/admin/history" class="text-sm text-gray-500 hover:text-inka-navy flex items-center gap-1 w-fit">
                ← Kembali ke Riwayat
            </a>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-red-100 overflow-hidden">
            <div class="bg-red-50 px-6 py-4 border-b border-red-100">
                ...
                <p class="text-sm text-red-700 mt-1">Tindakan ini tidak dapat dibatalkan. Permit akan dicabut dan pekerjaan harus segera dihentikan.</p>
            </div>
            
            <form action="/admin/approvals/{{ $permit->id }}/cancel" method="POST" class="px-6 py-5">
                @csrf
                ...
                <div class="mb-5">
                    ...
                    <textarea name="cancellation_reason" rows="3" required
                        ...
                        placeholder="Jelaskan alasan pencabutan izin, misal: pelanggaran APD, cuaca ekstrem..."></textarea>
                </div>

                <div class="mb-6">
                    <div class="flex items-center justify-between mb-2">
                        <div>
                            <p class="text-sm font-semibold text-gray-700">Tanda Tangan <span class="text-red-500">*</span></p>
                            <p class="text-xs text-gray-400">Tanda tangan Anda sebagai pihak yang membatalkan ({{ auth()->user()->name }} - {{ auth()->user()->role }})</p>
                        </div>
                ...
                <div class="flex justify-end pt-4 border-t border-gray-100 gap-3">
                    <a href="/admin/history" class="px-5 py-2.5 rounded-xl border border-gray-200 text-sm font-semibold text-gray-600 hover:border-gray-300 transition-colors">Batal</a>
