<x-app-layout>
    ...
    {{-- ===== WIDGET RINGKASAN (3 KARTU KLIKABLE) ===== --}}
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">

        {{-- Pending Review --}}
        <a href="/staff/approvals?status=Review Staff"
           class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 hover:shadow-md hover:border-blue-200 transition-all group">
            ...
            <p class="text-3xl font-bold text-blue-500">{{ $counts['pending'] }}</p>
            <p class="text-[10px] text-gray-400 mt-1">Menunggu tindak lanjut</p>
        </a>

        {{-- Permit Direvisi --}}
        <a href="/staff/approvals?status=Revision"
           class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 hover:shadow-md hover:border-red-200 transition-all group">
            ...
            <p class="text-3xl font-bold text-red-500">{{ $counts['revision'] }}</p>
            <p class="text-[10px] text-gray-400 mt-1">Dikembalikan ke Divisi</p>
        </a>

        {{-- Permit Hari Ini --}}
        <a href="/staff/approvals?date=today"
           class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 hover:shadow-md hover:border-gray-200 transition-all group">
            ...
            <p class="text-[10px] text-gray-400 mt-1">Masuk hari ini</p>
        </a>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <div class="flex items-center gap-3">
                <a href="/staff/approvals" class="text-sm font-semibold text-inka-navy hover:underline">
                    Lihat Semua →
                </a>
        ...
        @if($permits->isEmpty())
            ...
            <div class="flex flex-col items-center justify-center py-16 px-6 text-center">
                ...
                <p class="text-xs text-gray-400 mt-1 mb-6">Permit baru akan muncul di sini setelah Divisi mengirimkan pengajuan.</p>
            </div>
                ...
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-blue-50/30 transition-colors cursor-pointer"
                            onclick="window.location='/staff/approvals/{{ $permit->id }}'">
                            <td class="px-6 py-3.5">
                                <a href="/staff/approvals/{{ $permit->id }}"
