<x-app-layout>
    <x-slot name="title">History Permit (Senior Manager)</x-slot>

    {{-- ===== FILTER BAR ===== --}}
    <form method="GET" action="/senior-manager/history" class="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-4 mb-5 flex flex-wrap items-center gap-3">
        ...
        <a href="/senior-manager/history" class="text-sm text-gray-400 hover:text-gray-600 transition-colors">Reset</a>
        @endif
    </form>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <h3 class="text-sm font-semibold text-gray-800">Semua Data Permit (Global)</h3>
        </div>
        @if($permits->isEmpty())
                ...
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-blue-50/30 transition-colors">
                            ...
                            <td class="px-6 py-3.5"><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-semibold {{ $badge }}">{{ $permit->status }}</span></td>
