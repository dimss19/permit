<x-app-layout>
    ...
    <div class="flex items-center justify-between mb-5">
        <div class="flex items-center gap-2 text-sm text-gray-400">
            <a href="/senior-manager/dashboard" class="hover:text-gray-600 transition-colors">Dashboard</a>
            <span>/</span>
            <a href="/senior-manager/approvals" class="hover:text-gray-600 transition-colors">Review Permit</a>
            <span>/</span>
    ...
    @if($canReview)
    {{-- Aksi Review Senior Manager --}}
    <div class="mt-5 bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-5">
        <h3 class="text-sm font-semibold text-gray-800 mb-4">Tindak Lanjut Review (Senior Manager)</h3>
        
        <form action="/senior-manager/approvals/{{ $permit->id }}" method="POST">
            @csrf
            @method('PUT')
