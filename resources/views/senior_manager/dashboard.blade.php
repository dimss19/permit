<x-app-layout>
    <x-slot name="title">Dashboard — Senior Manager</x-slot>

    {{-- ===== WIDGET RINGKASAN (2 KARTU KLIKABLE) ===== --}}
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">

        {{-- Pending Final Approval --}}
        <a href="/senior-manager/approvals?status=Review Senior Manager"
           class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 hover:shadow-md hover:border-orange-200 transition-all group">
            <div class="flex items-center justify-between mb-3">
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide">Pending Final Approval</p>
            ...
            <p class="text-[10px] text-gray-400 mt-1">Menunggu persetujuan final Anda</p>
        </a>

        {{-- Permit Active Hari Ini --}}
        <a href="/senior-manager/history?status=Active"
           class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 hover:shadow-md hover:border-green-200 transition-all group">
            <div class="flex items-center justify-between mb-3">
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide">Permit Active Hari Ini</p>
            ...
            <p class="text-3xl font-bold text-green-500">{{ $counts['active_today'] }}</p>
            <p class="text-[10px] text-gray-400 mt-1">Disetujui hari ini (Active)</p>
        </a>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <div class="flex items-center gap-3">
                <a href="/senior-manager/approvals" class="text-sm font-semibold text-inka-navy hover:underline">
                    Lihat Semua →
                </a>
                <a href="/senior-manager/approvals"
        ...
        @if($permits->isEmpty())
            ...
            <div class="flex flex-col items-center justify-center py-16 px-6 text-center">
                ...
                <p class="text-sm font-semibold text-gray-700">Tidak ada permit yang menunggu persetujuan final.</p>
                <p class="text-xs text-gray-400 mt-1 mb-6">Permit akan muncul di sini setelah disetujui oleh Manager.</p>
            </div>
                ...
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-orange-50/30 transition-colors cursor-pointer"
                            onclick="window.location='/senior-manager/approvals/{{ $permit->id }}'">
                            <td class="px-6 py-3.5">
                                <a href="/senior-manager/approvals/{{ $permit->id }}"
