<x-app-layout>
    <x-slot name="title">History Permit (Manager)</x-slot>

    {{-- ===== FILTER BAR ===== --}}
    <form method="GET" action="/manager/history" class="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-4 mb-5 flex flex-wrap items-center gap-3">
        ...
        <a href="/manager/history" class="text-sm text-gray-400 hover:text-gray-600 transition-colors">Reset</a>
        @endif
    </form>
