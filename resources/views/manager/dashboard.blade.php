<x-app-layout>
    <x-slot name="title">Dashboard — Manager (Approval Tahap 2)</x-slot>

    {{-- ===== WIDGETS: Pending Approval | Permit Hari Ini ===== --}}
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-[10px] text-gray-400">Menunggu persetujuan Anda</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-800 mt-0.5">0</p>
                <p class="text-[10px] text-gray-400">Total masuk hari ini</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <div>
                ...
                <p class="text-xs text-gray-400 mt-0.5">Permit yang telah disetujui Staff dan menunggu persetujuan Anda</p>
            </div>
            {{-- Quick Action: Review Permit --}}
            <a href="/manager/approvals" class="inline-flex items-center gap-2 bg-inka-navy text-white text-sm font-semibold px-4 py-2 rounded-xl hover:opacity-90 transition-opacity">
            ...
            <table class="w-full text-left text-sm">
                <thead>
                    <tr class="text-xs text-gray-400 uppercase tracking-wide border-b border-gray-100">
                        ...
                        <th class="px-6 py-3 font-semibold">Disetujui Staff</th>
                ...
                <tbody>
                    <tr>
                        <td colspan="5" class="px-6 py-10 text-center text-sm text-gray-400">
                            Tidak ada permit yang menunggu approval saat ini.
                        </td>
                    </tr>
                </tbody>
            </table>
