<x-app-layout>
    ...
    {{-- Form --}}
    <form action="/divisi/permits" method="POST" id="permit-form" enctype="multipart/form-data">
        @csrf
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
                ...
                <div class="px-6 py-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <button type="button" onclick="selectTipe('Internal')" id="btn-internal"
                        class="tipe-btn group p-6 rounded-2xl border-2 border-inka-navy bg-inka-navy/5 text-left transition-all">
                        <div class="w-12 h-12 rounded-xl bg-inka-navy/10 flex items-center justify-center mb-3">
                            <svg class="w-6 h-6 text-inka-navy" fill="none" stroke="currentColor" viewBox="0 0 24 24">
